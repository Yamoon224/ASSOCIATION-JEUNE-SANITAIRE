<x-app-layout>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a class="btn btn-primary btn-with-icon" style="float: right" data-target="#create-doctor" data-toggle="modal">
                                ...
                                <div class="col-12">
                                    <table cellspacing="0" class="table" id="order-listing" width="100%">
                                        <thead>
                                            ...
                                            <th>@lang('locale.speciality', ['suffix'=>'', 'prefix'=>''])</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $item->speciality ? $item->speciality->name : __('locale.none') }}</td>
                                                <td>{{ $item->firstname." ".$item->name }}</td>
                                                <td>{{ $item->phone }}</td>
                                                <td>{{ $item->address }}</td>
                                                <td>
                                                    <div style="display: inline-block">
                                                        <a class="btn btn-primary" data-target="#edit-doctor{{ $item->id }}" data-toggle="modal">
                                                            <i class="typcn icon typcn-edit"></i>
                                                        </a>
                                                        <x-edit-doctor :doctor="$item" :specialities="$specialities"></x-edit-doctor>
                                                        <a class="btn btn-info" href="{{ route('doctors.show', $item->id) }}">
                                                            <i class="typcn icon typcn-eye"></i>
                                                        </a>
                                                    </div>
                                                    <form action="{{ route('doctors.destroy', $item->id) }}" style="display: inline-block" method="post">
                                                        @csrf
                                                        @method('DELETE')
    ...
    <x-create-doctor :specialities="$specialities"></x-create-doctor>
    @push('scripts')
